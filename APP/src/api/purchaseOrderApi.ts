...
export async function getPurchaseOrders(
  ...
  return {
    data: responseData.data.map((po: any) => ({
      ...
      weight: po.product_weight || po.weight || po.product?.weight || null,
...
export async function getPurchaseOrderDetail(id: string): Promise<PurchaseOrderDetail> {
  ...
  return {
    ...
    delivery_date: data.delivery_date || data.estimated_delivery || null,
    ...
    weight: data.product_weight || data.weight || data.product?.weight || null,
...
export async function createPurchaseOrder(data: CreatePurchaseOrderData): Promise<PurchaseOrderDetail> {
  ...
  return {
    ...
    delivery_date: result.delivery_date || result.estimated_delivery || null,
