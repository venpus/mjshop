...
import stockInboundRoutes from './stockInbound.js';
import shopOrderRoutes from './shopOrders.js';
import shopBuyerRoutes from './shopBuyers.js';
import shopShipmentRoutes from './shopShipments.js';
import shopSalesSettlementLedgerRoutes from './shopSalesSettlementLedger.js';
...
router.use('/stock-inbound', stockInboundRoutes);
router.use('/shop-orders', shopOrderRoutes);
router.use('/shop-buyers', shopBuyerRoutes);
router.use('/shop-shipments', shopShipmentRoutes);
router.use('/shop-sales-settlement/ledger', shopSalesSettlementLedgerRoutes);
