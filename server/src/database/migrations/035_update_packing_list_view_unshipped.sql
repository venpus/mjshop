-- 마이그레이션: 035_update_packing_list_view_unshipped
-- 설명: 패킹리스트 VIEW들 업데이트 (배송비 VIEW 포함, 배송 수량 VIEW의 미출고 수량 계산 로직 수정)
-- 날짜: 2024-12-24
-- 변경 내용: 
--   1. v_purchase_order_packing_shipping_cost VIEW 재생성 (ordered_quantity 컬럼 포함 확인)
--   2. v_purchase_order_shipping_summary VIEW의 미출고 수량 계산 기준을 발주 수량에서 업체 출고 수량으로 변경
